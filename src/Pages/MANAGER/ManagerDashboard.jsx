...
const ManagerDashboard = () => {
  ...
  // State to store selected caregiver for each caretaker (key is caretakerId)
  ...
  const handleCaregiverChange = async (caretakerId, eventKey) => {
    // Extract the caregiver ID from the eventKey
    ...
    // Update selectedCaregivers state
                        ...
                        <td>
                          ...
                          >
                            ...
                            >
                              ...
                              {selectedCaregivers[caretaker.caretakerId]?.name ||
                                "Select Caregiver"}
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                    ...
                    <Card>
                      <Card.Body>
                        ...
                        <Card.Text>
                          ...
                          <p>
                            Unavailable Dates:{" "}
                            {selectedCaregiver.unavailableDates
