...
//     const caregiverId = caregivers.find(
//       (caregiver) =>
//         caregiver.firstName + caregiver.gender === eventKey
//     ).caregiverId;
...
const ManagerDashboard = () => {
  ...
  const handleCaregiverChange = async (eventKey) => {
    ...
    setSelectedCaregiverName(
      `${selectedCaregiver.firstName} (${selectedCaregiver.gender})`
    );
