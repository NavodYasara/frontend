      ...
      <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            ...
            <List>
              <ListItem>
                <ListItemText primary="Name" secondary={caregiverDetails.name} />
              </ListItem>
              <ListItem>
                <ListItemText primary="Age" secondary={caregiverDetails.age} />
              </ListItem>
              <ListItem>
                <ListItemText primary="Experience" secondary={caregiverDetails.experience} />
              </ListItem>
            </List>
          </Grid>
          <Grid item xs={12} sm={6}>
